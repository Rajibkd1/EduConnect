...
<style>
    ...
    button {
        border-radius: 25px;
        border: none;
        background: linear-gradient(45deg, #FF4B2B, #FF6B4B);
        color: #FFFFFF;
        font-size: 13px;
        font-weight: 600;
        padding: 15px 45px;
    ...
    .logo h2 {
        ...
        color: #FF4B2B;
        margin-bottom: 5px;
        text-shadow: 0 2px 4px rgba(255,75,43,0.3);
    }
    ...
    .message.success {
        background: linear-gradient(45deg, rgba(40, 167, 69, 0.9), rgba(72, 187, 120, 0.9));
        color: #ffffff;
        box-shadow: 0 4px 15px rgba(40, 167, 69, 0.3);
    }

    .message.error {
        background: linear-gradient(45deg, rgba(220, 53, 69, 0.9), rgba(248, 81, 73, 0.9));
        color: #ffffff;
