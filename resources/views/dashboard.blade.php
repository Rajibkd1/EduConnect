...
@section('content')
    ...
    <div class="min-h-screen bg-gray-50">
        <div class="p-4 sm:p-6">
            ...
            <div
                class="bg-white rounded-xl p-4 sm:p-6 lg:p-8 shadow-lg border border-gray-200 mb-6 sm:mb-8 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex flex-col space-y-4 sm:hidden">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                <h2 class="text-lg font-bold text-gray-900 mb-1">{{ auth()->user()->name }}</h2>
                    ...
                    <div class="hidden sm:flex items-center justify-between">
                        <div class="flex items-center space-x-4 lg:space-x-6">
                            ...
                            <div>
                                <h2 class="text-xl lg:text-2xl font-bold text-gray-900 mb-1 lg:mb-2">
                                    {{ auth()->user()->name }}</h2>
                                <div class="flex items-center space-x-3 mb-1 lg:mb-2">
                                    <span
                                        class="inline-flex items-center px-2 lg:px-3 py-1 rounded-full text-sm font-semibold bg-blue-100 text-blue-800 border border-blue-200">
