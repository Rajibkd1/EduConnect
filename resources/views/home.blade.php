...
@section('content')
    ...
    <section id="features" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-20">
                <h2 class="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">{{ __('home.features.title') }}</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="feature-card group bg-white rounded-2xl p-8 subtle-shadow hover:elegant-shadow border border-gray-100">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-4">{{ __('home.features.students.title') }}</h3>
                ...
                <div class="feature-card group bg-white rounded-2xl p-8 subtle-shadow hover:elegant-shadow border border-gray-100">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-4">{{ __('home.features.tutors.title') }}</h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div class="feature-card group bg-white rounded-2xl p-8 subtle-shadow hover:elegant-shadow border border-gray-100">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-4">{{ __('home.features.guardians.title') }}</h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div class="feature-card group bg-white rounded-2xl p-8 subtle-shadow hover:elegant-shadow border border-gray-100">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-4">{{ __('home.features.security.title') }}</h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div class="feature-card group bg-white rounded-2xl p-8 subtle-shadow hover:elegant-shadow border border-gray-100">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-4">{{ __('home.features.scheduling.title') }}</h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div class="feature-card group bg-white rounded-2xl p-8 subtle-shadow hover:elegant-shadow border border-gray-100">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-4">{{ __('home.features.tracking.title') }}</h3>
                    <p class="text-gray-600 leading-relaxed">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="order-2 lg:order-1">
                    <h2 class="text-4xl sm:text-5xl font-bold text-gray-900 mb-8">{{ __('home.about.title') }}</h2>
                    ...
                    <div class="grid grid-cols-2 gap-8">
                        <div class="text-center p-6 bg-white rounded-2xl subtle-shadow">
                            ...
                            <div class="text-gray-600 font-medium">{{ __('home.about.stats.students') }}</div>
                        </div>
                        <div class="text-center p-6 bg-white rounded-2xl subtle-shadow">
                            <div class="text-4xl font-bold text-gray-900 mb-2">500+</div>
                            <div class="text-gray-600 font-medium">{{ __('home.about.stats.tutors') }}</div>
                        </div>
                        <div class="text-center p-6 bg-white rounded-2xl subtle-shadow">
                            <div class="text-4xl font-bold text-gray-900 mb-2">50+</div>
                            <div class="text-gray-600 font-medium">{{ __('home.about.stats.subjects') }}</div>
                        </div>
                        <div class="text-center p-6 bg-white rounded-2xl subtle-shadow">
                            <div class="text-4xl font-bold text-gray-900 mb-2">98%</div>
                            <div class="text-gray-600 font-medium">{{ __('home.about.stats.satisfaction') }}</div>
                        </div>
                    </div>
                </div>
                <div class="order-1 lg:order-2">
                    <div class="bg-white rounded-3xl p-10 elegant-shadow border border-gray-100">
                        <h3 class="text-3xl font-semibold text-gray-900 mb-8">{{ __('home.about.how_it_works.title') }}</h3>
                        <div class="space-y-8">
                            <div class="flex items-start group">
                                ...
                                <div class="ml-6">
                                    <h4 class="text-xl font-semibold text-gray-900 mb-2">{{ __('home.about.how_it_works.step1.title') }}</h4>
                                    <p class="text-gray-600 leading-relaxed">{{ __('home.about.how_it_works.step1.description') }}</p>
                                </div>
                            </div>
                            <div class="flex items-start group">
                                ...
                                <div class="ml-6">
                                    <h4 class="text-xl font-semibold text-gray-900 mb-2">{{ __('home.about.how_it_works.step2.title') }}</h4>
                                    <p class="text-gray-600 leading-relaxed">{{ __('home.about.how_it_works.step2.description') }}</p>
                                </div>
                            </div>
                            <div class="flex items-start group">
                                ...
                                <div class="ml-6">
                                    <h4 class="text-xl font-semibold text-gray-900 mb-2">{{ __('home.about.how_it_works.step3.title') }}</h4>
                                    <p class="text-gray-600 leading-relaxed">{{ __('home.about.how_it_works.step3.description') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="contact" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-20">
                <h2 class="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">{{ __('home.contact.title') }}</h2>
                <div class="w-16 h-1 bg-gray-800 mx-auto mb-6 rounded-full"></div>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto font-light leading-relaxed">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="group text-center p-8 bg-gray-50 rounded-2xl hover:bg-white subtle-shadow hover:elegant-shadow transition-all duration-300 border border-gray-100">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">{{ __('home.contact.email') }}</h3>
                    <p class="text-gray-600 font-medium">{{ __('home.contact.email_address') }}</p>
                </div>
                ...
                <div class="group text-center p-8 bg-gray-50 rounded-2xl hover:bg-white subtle-shadow hover:elegant-shadow transition-all duration-300 border border-gray-100">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">{{ __('home.contact.phone') }}</h3>
                    <p class="text-gray-600 font-medium">{{ __('home.contact.phone_number') }}</p>
                </div>
                ...
                <div class="group text-center p-8 bg-gray-50 rounded-2xl hover:bg-white subtle-shadow hover:elegant-shadow transition-all duration-300 border border-gray-100">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">{{ __('home.contact.address') }}</h3>
                    <p class="text-gray-600 font-medium">{{ __('home.contact.physical_address') }}</p>
                </div>
            </div>
        </div>
    </section>
